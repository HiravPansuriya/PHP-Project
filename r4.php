...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["option"]) && !empty($_POST["option"])) {
        ...
        foreach ($selectedOptions as $option) {
            $sql = "SELECT value, email FROM r4 WHERE id=?";
                ...
                if (mysqli_stmt_execute($stmt)) {
                    ...
                    if (isset($_POST["book"])) {
                        if ($value == 1) {
                            ...
                            $sql_update = "UPDATE r4 SET value=1, email=? WHERE id=?";
                    ...
                    elseif (isset($_POST["unbook"])) {
                        if ($value == 0) {
                            ...
                            $sql_update = "UPDATE r4 SET value=0, email=NULL WHERE id=?";
                            if ($stmt_update = mysqli_prepare($link, $sql_update)) {
...
<body>
    ...
    <div class="heading">Restaurant 4</div>
    <div class="container">
    <?php if ($alertMessage): ?>
